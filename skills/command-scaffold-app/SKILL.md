...
3. Use the SDK 54 baseline in [the Expo reference](../../docs/references/01-expo-sdk-54.md): TypeScript, Expo Router where file-based navigation fits, and `npx expo install` for Expo-compatible dependencies.
