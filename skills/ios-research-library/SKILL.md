---
name: "ios-research-library"
description: "Find the package's versioned Expo, EAS, monetization, product-design, listing, and iOS release-readiness references. Use before giving high-stakes iOS or Expo SDK 54 implementation and release guidance."
---

# iOS and Expo reference library

Read the smallest relevant reference before drafting implementation or release guidance. These documents set a safe baseline; re-check official Apple, Expo, and provider documentation when a decision depends on current policy or pricing.
